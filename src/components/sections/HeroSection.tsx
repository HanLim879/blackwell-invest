...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative bg-[#5666D8] py-0 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 gap-0 items-stretch min-h-[70vh] md:min-h-[80vh]">
          {/* Left: Full-height Hand Image */}
          <div className="relative">
            <Image
              src="/images/phones/hand.png"
          ...
          {/* Right: Content, same height as left and right-aligned */}
          <div className="flex items-center">
            <div className="w-full text-white space-y-6 py-12 md:py-16 md:pl-8">
              <h1 className="text-5xl md:text-6xl font-extrabold text-right text-[#01f2f2]">
                COPY TRADING
              </h1>
              <h2 className="text-3xl md:text-4xl font-light text-right text-white">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 space-y-4">
                ...
                <Button
                  ...
                  className="w-full md:w-auto ml-auto block"
                >
                  Register Now
                </Button>
